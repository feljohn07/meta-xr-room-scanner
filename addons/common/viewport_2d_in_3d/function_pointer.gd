...
@export var select_pressed_threshold := 0.5
@export var select_release_threshold := 0.2
...
func _is_trigger_action(p_name: String) -> bool:
	return p_name == select_action or p_name == "trigger" or p_name == "trigger_click" or p_name == "select"
